package com.jay2u8809.codesamples.Corp.uxxnjp.adoooooakr.api.qrcode;
...
class QrCodeApiTest {
    ...
    @Test
    void generateQrCodeByImageUriTest () {
        ...
        dummyUriList = dummyUriList.stream()
                .map(f -> this.generateQrCodeByImageUri(f, 0))
     ...
     * @return String
     */
    private String generateQrCodeByImageUri (String inputUri, int inputSize) {
        ...
        qrCodeSize = (inputSize == 0) ? qrCodeSize : inputSize;
