...
public class NaverMapApi {
     ...
     * Address -> Geocode
     * @param address
     * @param isHttpConnection
     */
    public Map<String, Object> getGeoCodeInfo(String address, boolean isHttpConnection) {

        // Address data
        address = isHttpConnection ? address : "서울 강남구 대치동 942-5번지 삼성빌딩 12층";
